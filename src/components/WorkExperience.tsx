...
const experienceItems: ExperienceItem[] = [
  {
    title: "Maitexa Technologies Pvt Ltd",
    description:
      "Successfully completed the internship on PYTHON DJANGO, worked on the project Pharmacy Management System.",
    image: "/images/maitexa.jpeg",
  },
  {
    title: "Finedge IT Finishing School",
    description:
      "Successfully Completed internship program in .Net Web Application Using C#",
    image: "/images/finedge.jpeg",
  },
  {
    title: "Spectrum Softtech Solutions Pvt Ltd",
    description:
      "Successfully completed internship with Software Testing.",
    image: "/images/spectrum.jpeg",
  },
  {
    title: "Sinet Education (MERN)",
    description:
      "Successfully completed MERN Stack Development with 'A' Grade.",
    image: "/images/sinet.jpeg",
  },
];
          ...
          {experienceItems.map((item, index) => (
            ...
            >
              ...
              <div className="relative  flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6 md:gap-8">
                {/* icon */}
                <div className="relative shrink-0 w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 transition-transform duration-300 group-hover:-translate-y-1 overflow-hidden rounded-xl flex-none">
                  <Image
                    src={item.image}
                    alt={item.title}
                    fill
                    className="object-cover drop-shadow-[0_8px_24px_rgba(113,39,186,0.35)]"
                    priority
                  />
                </div>
